export const translations = {
  de: {
    ...
    home: {
      ...
      description: "bitte füllen Sie den digitalen Meldeschein aus. Dies ist gesetzlich vorgeschrieben und hilft uns dabei, Ihren Aufenthalt ordnungsgemäß zu dokumentieren.",
      thankYou: "Vielen Dank für Ihr Verständnis und einen angenehmen Aufenthalt!",
    ...
    signature: {
      ...
      description: "Bitte unterschreiben Sie mit Ihrem Finger oder der Maus im Feld unten",
      clearButton: "Löschen"
    },
    ...
    privacy: {
      ...
      textContinue: "gelesen und akzeptiere diese. Ich bin damit einverstanden, dass meine Daten zur Erfüllung der gesetzlichen Meldepflicht verarbeitet werden."
    },
    ...
    validation: {
      ...
      incompleteTravellers: "Bitte füllen Sie alle Angaben für alle Mitreisende aus",
    ...
    success: {
      title: "Vielen Dank!",
      message: "Ihr digitaler Meldeschein wurde erfolgreich übermittelt und per E-Mail an das Hotel gesendet.",
    ...
    placeholders: {
      ...
      nationality: "z.B. deutsch, türkisch, etc.",
  ...
  en: {
    ...
    home: {
      ...
      description: "please fill out the digital registration form. This is legally required and helps us properly document your stay.",
    ...
    privacy: {
      ...
      textContinue: "and accept it. I agree that my data may be processed to fulfill the legal registration requirements."
    },
    ...
    validation: {
      ...
      incompleteTravellers: "Please fill in all information for all co-travellers",
    ...
    success: {
      title: "Thank You!",
      message: "Your digital registration has been successfully submitted and sent to the hotel by email.",
    ...
    placeholders: {
      ...
      nationality: "e.g. German, Turkish, etc.",
